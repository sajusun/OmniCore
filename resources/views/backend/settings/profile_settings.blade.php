                ...
                <div class="card-header bg-light bg-gradient py-4 px-4 border-bottom-0">
                    <div class="d-flex flex-column flex-lg-row align-items-start align-items-lg-center gap-4">
                        ...
                        <div class="position-relative flex-shrink-0">
                            <div class="profile-img-main rounded-circle overflow-hidden border border-4 border-white shadow-sm" style="width: 120px; height: 120px;">
                                <img src="{{ Auth::user()->avatar ? asset(Auth::user()->avatar) : asset('default/profile.png') }}"
                                    alt="Profile Picture" class="w-full h-full object-cover">
                            </div>
                            <button id="uploadImageBtn"
                                class="btn btn-primary btn-sm rounded-circle position-absolute bottom-0 end-0 p-2 d-flex align-items-center justify-content-center shadow" style="width: 32px; height: 32px;">
                        ...
                        <div class="flex-grow-1 min-w-0">
                            ...
                            <div class="d-flex flex-wrap align-items-center gap-2 mt-3">
                                <span class="badge bg-success bg-opacity-10 text-success rounded-pill border border-success border-opacity-25 px-3 py-2 small">
                                    Active
                                </span>
                                <span class="badge bg-secondary bg-opacity-10 text-secondary rounded-pill border border-secondary border-opacity-25 px-3 py-2 small">
                        ...
                        <div class="card-body p-4">
                            <form class="form form-horizontal" method="post"
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6 form-group">
                                        <label for="firstname" class="form-label small fw-medium">
                            ...
                            <form class="form form-horizontal" method="post"
                                ...
                                <div class="row g-3">
                                    <div class="col-12 form-group">
                                        <label for="old_password" class="form-label small fw-medium">
