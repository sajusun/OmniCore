<x-admin-layout>
    ...
    @slot('header')
        <div class="d-flex flex-row justify-content-between align-items-center gap-3 w-100">
            ...
            <span class="text-dark fw-bold">
                <button class="btn btn-outline-secondary btn-sm" onclick="location.href=`{{ route('admin.optimize') }}`">
                    <i class="fas fa-sync fs-6 me-1"></i> Optimize
                </button>
            </span>
        </div>
    @endslot
    ...
    <div class="py-4">
        <div class="container-fluid">
            ...
            {{-- Tab Panel --}}
            <div x-data="{ activeTab: '{{ session('_env_tab', 'app') }}' }" class="card shadow-sm border overflow-hidden">

                {{-- Tab Navigation --}}
                <div class="card-header bg-light border-bottom p-0 overflow-x-auto">
                    <div class="nav nav-tabs border-bottom-0 px-3 pt-2 gap-1 flex-nowrap">

                        @php
                            $tabs = [
                                ['key' => 'app',          'label' => 'Application', 'icon' => 'M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6',   'color' => 'primary'],
                                ['key' => 'jwt',          'label' => 'JWT',         'icon' => 'M15 7a2 2 0 012 2m4 0a6 6 0 01-7.743 5.743L11 17H9v2H7v2H4a1 1 0 01-1-1v-2.586a1 1 0 01.293-.707l5.964-5.964A6 6 0 1121 9z',                       'color' => 'primary'],
                                ['key' => 'firebase',     'label' => 'Firebase',    'icon' => 'M17.657 18.657A8 8 0 016.343 7.343S7 9 9 10c0-2 .5-5 2.986-7C14 5 16.09 5.777 17.656 7.343A7.975 7.975 0 0120 13a7.975 7.975 0 01-2.343 5.657z',    'color' => 'primary'],
                                ['key' => 'mail',         'label' => 'Mail',        'icon' => 'M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z',                                            'color' => 'primary'],
                                ['key' => 'verification', 'label' => 'Verification','icon' => 'M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z', 'color' => 'primary'],
                                ['key' => 'system',       'label' => 'System',      'icon' => 'M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z', 'color' => 'primary'],
                            ];
                        @endphp
                ...
                <div class="card-body p-4">
                    ...
                    <div x-show="activeTab === 'app'" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0 translate-y-1" x-transition:enter-end="opacity-100 translate-y-0">
                        <div class="mb-4">
                            <h5 class="card-title fw-bold">Application Settings</h5>
                            <p class="card-subtitle text-muted small">Core application identity and URL configuration.</p>
                        </div>
                        <form method="POST" action="{{ route('admin.setting.general.env.app.update') }}">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    <label class="form-label small fw-medium">Debug Mode</label>
                    ...
                    <div x-show="activeTab === 'jwt'" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0 translate-y-1" x-transition:enter-end="opacity-100 translate-y-0">
                        <div class="mb-4">
                            <h5 class="card-title fw-bold">JWT Token Settings</h5>
                            <p class="card-subtitle text-muted small">Configure API authentication token lifetimes and security options.</p>
                        </div>
                        <div class="alert alert-warning d-flex align-items-start gap-2 px-3 py-2 text-dark small" role="alert">
                            ...
                            <div class="row g-3">
                                <div class="col-12">
                                    <label class="form-label small fw-medium">
                                        JWT Secret
                                        <span class="badge bg-warning text-dark ms-2 small">sensitive</span>
                                    </label>
                                ...
                                <div class="col-md-6">
                                    <label class="form-label small fw-medium">Algorithm</label>
                                    <select name="jwt_algo" class="form-select">
                                ...
                                <div class="col-md-6">
                                    <label class="form-label small fw-medium">Blacklist Enabled</label>
                                    <select name="jwt_blacklist_enabled" class="form-select">
                    ...
                    <div x-show="activeTab === 'firebase'" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0 translate-y-1" x-transition:enter-end="opacity-100 translate-y-0">
                        <div class="mb-4">
                            <h5 class="card-title fw-bold">Firebase Settings</h5>
                            <p class="card-subtitle text-muted small">Configure Firebase project for push notifications and realtime database.</p>
                        </div>
                        <div class="alert alert-info d-flex align-items-start gap-2 px-3 py-2 text-dark small" role="alert">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" class="mt-0.5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                            </svg>
                    ...
                    <div x-show="activeTab === 'mail'" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0 translate-y-1" x-transition:enter-end="opacity-100 translate-y-0">
                        <div class="mb-4">
                            <h5 class="card-title fw-bold">Mail / SMTP Settings</h5>
                            <p class="card-subtitle text-muted small">Configure your outgoing mail server (SMTP) credentials.</p>
                        </div>
                        <form method="POST" action="{{ route('admin.setting.general.env.mail.update') }}">
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <label class="form-label small fw-medium">Mail Mailer</label>
                                ...
                                <div class="col-md-6">
                                    <label class="form-label small fw-medium">Encryption Scheme</label>
                    ...
                    <div x-show="activeTab === 'verification'" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0 translate-y-1" x-transition:enter-end="opacity-100 translate-y-0">
                        <div class="mb-4">
                            <h5 class="card-title fw-bold">Verification Settings</h5>
                            <p class="card-subtitle text-muted small">OTP and token-based user verification configuration.</p>
                        </div>
                        <form method="POST" action="{{ route('admin.setting.general.env.verification.update') }}">
                            ...
                            <div class="mb-4 pb-4 border-bottom">
                                <p class="text-uppercase small fw-bold text-muted mb-3">General</p>
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        <label class="form-label small fw-medium">Default Verification Type</label>
                                        <select name="verification_default_type" class="form-select">
                            ...
                            <div class="mb-4 pb-4 border-bottom">
                                <p class="text-uppercase small fw-bold text-muted mb-3">OTP Settings</p>
                                <div class="row g-3">
                                    <div class="col-md-6">
                            ...
                            <div class="mb-4 pb-4 border-bottom">
                                <p class="text-uppercase small fw-bold text-muted mb-3">Token Settings</p>
                                <div class="row g-3">
                                    <div class="col-md-6">
                            ...
                            <div class="mb-4 pb-4 border-bottom">
                                <p class="text-uppercase small fw-bold text-muted mb-3">Resend & Block Rules</p>
                                <div class="row g-3">
                                    <div class="col-md-4">
                            ...
                            <div>
                                <p class="text-uppercase small fw-bold text-muted mb-3">Redirect URLs</p>
                                <div class="row g-3">
                                    <div class="col-md-6">
                    ...
                    <div x-show="activeTab === 'system'" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0 translate-y-1" x-transition:enter-end="opacity-100 translate-y-0">
                        <div class="mb-4">
                            <h5 class="card-title fw-bold">System Feature Toggles</h5>
                            <p class="card-subtitle text-muted small">Enable or disable system-wide features and notification channels.</p>
                        </div>
                        <form method="POST" action="{{ route('admin.setting.general.env.system.update') }}">
                            ...
                            {{-- Feature Flags --}}
                            <div class="mb-4 pb-4 border-bottom">
                                <p class="text-uppercase small fw-bold text-muted mb-3">Feature Flags</p>
                                <div class="row g-3">
                                    @php
                                        $toggles = [
                            ...
                            {{-- Service Toggles --}}
                            <div class="mb-4 pb-4 border-bottom">
                                <p class="text-uppercase small fw-bold text-muted mb-3">Service Channels</p>
                                <div class="row g-3">
                                    @php
                                        $serviceToggles = [
                            ...
                            <div class="mb-4 pb-4 border-bottom">
                                <p class="text-uppercase small fw-bold text-muted mb-3">Notification Channels</p>
                                <div class="row g-3">
                                    @php
                                        $notifChannels = [
                            ...
                            {{-- Misc --}}
                            <div>
                                <p class="text-uppercase small fw-bold text-muted mb-3">Miscellaneous</p>
                                <div class="row g-3">
                                    <div class="col-md-6">
            ...
            <div class="row g-3 mt-4">
                <div class="col-md-4">
                    <div class="card p-3 d-flex flex-row align-items-center gap-3 border shadow-sm h-100">
                        ...
                        <div>
                            <p class="text-muted small mb-0">Config file</p>
                            <p class="fw-semibold mb-0">.env application settings</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card p-3 d-flex flex-row align-items-center gap-3 border shadow-sm h-100">
                        ...
                        <div>
                            <p class="text-muted small mb-0">Risk level</p>
                            <p class="fw-semibold mb-0">High — use with care</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card p-3 d-flex flex-row align-items-center gap-3 border shadow-sm h-100">
                        ...
                        <div>
                            <p class="text-muted small mb-0">Effect</p>
                            <p class="fw-semibold mb-0">Requires config:clear</p>
                        </div>
                    </div>
                </div>
            </div>
