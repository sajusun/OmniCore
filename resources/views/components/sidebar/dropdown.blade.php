...
<div x-data="{ open: {{ $active ? 'true' : 'false' }} }">
    <button @click="open = !open"
        ...
        <div class="d-flex align-items-center">
            @if(isset($icon))
            <div class="flex-shrink-0 transition-colors {{ $iconClasses }}" :class="sidebarDesktopOpen ? 'me-3' : ''"
        ...
        <i class="fas fa-chevron-right small text-muted transition-transform" :class="open ? 'rotate-90' : ''"
            x-show="sidebarDesktopOpen" style="transition: transform 0.2s;"></i>
    </button>
