<x-admin-layout>
            ...
            <x-card title="General Information">
                <div class="row g-3">
                    ...
                    <div class="col-12">
                        ...
                        <div class="p-3 bg-light border rounded fw-medium small">
                ...
                <div>
                    <div class="d-flex align-items-center gap-3 mb-3">
                        <div class="d-flex align-items-center justify-content-center rounded-circle bg-primary bg-opacity-10 text-primary fw-bold"
                             style="width: 42px; height: 42px; font-size: 0.85rem; flex-shrink: 0;">
            ...
            <x-card title="Request Context">
                <div class="row g-3">
                    ...
                    <div class="col-6">
                        ...
                        <span class="badge bg-primary text-uppercase fw-bold mt-1">
                    ...
                    <div class="col-12">
                        ...
                        <div class="p-2 bg-light border rounded font-monospace small text-break user-select-all mt-1" style="line-height: 1.6;">
    ...
    <div class="row g-4 mb-4">
        <div class="col-12">
            <x-card title="Tracing & Batch Audit">
                <span class="d-block text-uppercase small fw-semibold text-muted mb-1">Batch UUID</span>
                <div class="p-2 bg-light border rounded font-monospace fw-bold small user-select-all text-break mt-1 d-inline-block">
    ...
    <div class="row g-4 mb-4">
        ...
        <div class="col-12 col-lg-6">
            <x-card title="Old Values (Before Change)">
                ...
                <pre class="text-xs font-monospace bg-dark text-success p-3 rounded overflow-auto user-select-all" style="max-height: 24rem; font-size: 0.78rem;"><code>{{ json_encode($activityLog->old_values, JSON_PRETTY_PRINT | JSON_UNESCAPED_SLASHES) }}</code></pre>
                @else
        ...
        <div class="col-12 col-lg-6">
            <x-card title="New Values (After Change)">
                ...
                <pre class="font-monospace bg-dark text-info p-3 rounded overflow-auto user-select-all" style="max-height: 24rem; font-size: 0.78rem;"><code>{{ json_encode($activityLog->new_values, JSON_PRETTY_PRINT | JSON_UNESCAPED_SLASHES) }}</code></pre>
                @else
                <div class="text-center py-5 text-muted fst-italic small">
    ...
    <div class="row g-4">
        <div class="col-12">
            <x-card title="Extended Properties / Meta">
                ...
                <pre class="font-monospace bg-dark text-warning p-3 rounded overflow-auto user-select-all" style="max-height: 24rem; font-size: 0.78rem;"><code>{{ json_encode($activityLog->properties, JSON_PRETTY_PRINT | JSON_UNESCAPED_SLASHES) }}</code></pre>
                @else
                <div class="text-center py-5 text-muted fst-italic small">
