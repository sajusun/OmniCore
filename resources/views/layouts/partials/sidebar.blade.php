...
<aside id="app-sidebar"
    ...
    <div class="d-flex align-items-center border-bottom px-3" style="height: 64px; white-space: nowrap;"
        ...
        <button @click="sidebarMobileOpen = false"
            class="btn btn-link text-muted p-0 d-lg-none position-absolute end-0 me-3">
    ...
    <!-- Sidebar Links -->
    <nav class="flex-grow-1 p-3 overflow-x-hidden">
        ...
        <x-sidebar.link href="{{ route('admin.app-supports.index') }}" :active="request()->routeIs('admin.app-supports.*')">
            <x-slot name="icon">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
