{{--
    Email Layout Shell — rendered by App\View\Components\EmailLayout
    Usage: <x-email-layout title="..." preheader="...">
               <x-mail.header ... />
               <x-mail.body> ... </x-mail.body>
               <x-mail.footer />
           </x-email-layout>

    Variables ($title, $preheader) are injected as public properties
    from the EmailLayout component class.
--}}
...
<body id="body"
    ...
    <div aria-hidden="true"
         style="display: none; font-size: 1px; color: #f0f4f8; line-height: 1px;
    ...
    <table id="bodyTable" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%"
           style="background-color: #f0f4f8; min-width: 100%; margin: 0; padding: 0;">
        <tr>
