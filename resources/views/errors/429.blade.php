@extends('auth.app', ['title' => '429 Too Many Requests'])
            ...
            <div class="col-md-8 col-lg-6">
                <div class="card shadow-lg border-0 rounded-4 bg-white p-5">
                    <div class="error-template">
                        <h1 class="display-1 fw-bolder text-danger mb-3" style="font-size: 6rem;">429</h1>
                        <h3 class="fw-semibold text-dark mb-2">Too Many Requests</h3>
                        <p class="text-muted mb-4 fs-16" style="line-height: 1.6;">
                            You have made too many requests in a short period. Please wait a moment and try again later.
                        </p>
                        <div>
