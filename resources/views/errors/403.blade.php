@extends('auth.app', ['title' => '403 Forbidden'])
            ...
            <div class="col-md-8 col-lg-6">
                <div class="card shadow-lg border-0 rounded-4 bg-white p-5">
                    <div class="error-template">
                        <h1 class="display-1 fw-bolder text-danger mb-3" style="font-size: 6rem;">403</h1>
                        <h3 class="fw-semibold text-dark mb-2">Access Forbidden</h3>
