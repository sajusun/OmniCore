...
class NewsletterController extends Controller
{
    public function subscribe(Request $request): JsonResponse
    {
        ...
        if ($existing) {
            return $this->error("You're already subscribed to our newsletter!", null, 409);
        }
        ...
        try {
            ...
            return $this->success(null, 'Successfully subscribed! Check your email for a welcome message.', 201);
        } catch (Exception $e) {
            ...
            return $this->error('Failed to subscribe. Please try again later.', null, 500);
        }
    }
    ...
    public function unsubscribe(Request $request): JsonResponse
    {
        ...
        if (!$subscriber) {
            return $this->error('Email not found in our subscriber list.', null, 404);
        }
