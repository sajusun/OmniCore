...
use App\Http\Requests\Chat\CreateSingleRoomRequest;
...
class ChatRoomController extends Controller
{
    ...
    public function single(CreateSingleRoomRequest $request)
    {
        ...
        if (!$this->permissionService->canCreateRoom($creator, \App\Enums\Chat\ChatRoomTypeEnum::SINGLE, [$targetUserId])) {
    ...
    public function group(CreateGroupRequest $request)
    {
        ...
        if (!$this->permissionService->canCreateRoom($creator, \App\Enums\Chat\ChatRoomTypeEnum::GROUP, $validated['participant_ids'])) {
    ...
    public function channel(CreateChannelRequest $request)
    {
        ...
        if (!$this->permissionService->canCreateRoom($creator, \App\Enums\Chat\ChatRoomTypeEnum::CHANNEL)) {
