<x-admin-layout>
    ...
    <div class="d-flex align-items-center justify-content-between mb-4">
        <div>
            ...
            <h4 class="fw-bold text-dark mb-0">Brands Directory</h4>
        </div>
    </div>

    <div class="card border-0 shadow-sm mb-4" style="border-radius: 0;">
        <div class="card-body p-3">
            <x-datatable id="brands-datatable" :url="route('admin.brands.index')" :columns="[
                ['data' => 'DT_RowIndex', 'name' => 'DT_RowIndex', 'title' => 'SL', 'orderable' => false, 'searchable' => false],
                ['data' => 'name', 'name' => 'name', 'title' => 'Brand Name'],
