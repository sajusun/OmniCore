<x-admin-layout>
    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('admin.subscriptions.index') }}" class="px-4 py-2 bg-gray-100 text-gray-700 rounded-md text-sm hover:bg-gray-200">
                Back to List
            </a>
        </div>
    </x-slot>
                    ...
                    <div>
                        ...
                        <dl class="space-y-3 text-sm">
                            ...
                            <div class="flex justify-between border-b pb-2">
                                ...
                                <dd class="font-bold uppercase text-xs px-2 py-0.5 rounded {{ $subscription->isActive() ? 'bg-green-100 text-green-700' : 'bg-gray-100 text-gray-700' }}">
