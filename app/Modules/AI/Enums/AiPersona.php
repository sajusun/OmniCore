...
enum AiPersona: string
{
    ...
    public function systemPrompt(): string
    {
        ...
        return match ($this) {
            self::SUPPORT_AGENT => "You are an intelligent, empathetic, and professional customer support assistant for {$appName}. You resolve issues accurately and warmly.",
            self::SHOPPING_ASSISTANT => "You are a personalized shopping advisor for {$appName} marketplace. You recommend products, check availability, and help customers find top deals.",
