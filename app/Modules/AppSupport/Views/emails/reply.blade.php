<x-mail.layout :title="'Support Update — ' . config('app.name', 'CruzeHub')" :preheader="'Admin replied to your report #' . $support->ticket_no">
    ...
    <x-mail.body>
        ...
        <!-- Admin Response Box -->
        <div style="background-color: #eef2ff; border: 1px solid #c7d2fe; border-left: 4px solid #6366f1; padding: 18px; margin: 20px 0;">
        ...
        <div style="background-color: #f9fafb; border: 1px solid #e5e7eb; padding: 14px; margin: 16px 0;">
