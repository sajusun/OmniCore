        ...
        <div class="row g-4">
            ...
            <div class="col-lg-8">
                ...
                <div class="card border-0 shadow-sm mb-4">
                    <div class="card-header bg-light-subtle py-3 border-bottom d-flex justify-content-between align-items-center">
                        <div class="d-flex align-items-center gap-2">
                            <div class="avatar-sm bg-primary text-white d-flex align-items-center justify-content-center fw-bold" style="width: 36px; height: 36px;">
                ...
                @foreach($ticket->replies as $reply)
                    <div class="card border-0 shadow-sm mb-4 {{ $reply->is_internal_note ? 'border-warning border-start border-4 bg-warning-subtle' : '' }}">
                        <div class="card-header bg-transparent py-3 border-bottom d-flex justify-content-between align-items-center">
                            <div class="d-flex align-items-center gap-2">
                                <div class="avatar-sm {{ $reply->is_internal_note ? 'bg-warning text-dark' : ($reply->user_id === $ticket->user_id ? 'bg-primary text-white' : 'bg-success text-white') }} d-flex align-items-center justify-content-center fw-bold" style="width: 36px; height: 36px;">
                        ...
                        <form method="POST" action="{{ route('admin.tickets.reply', $ticket) }}" enctype="multipart/form-data">
                            ...
                            @if($cannedResponses->isNotEmpty())
                                <div class="mb-3">
                                    ...
                                    <select class="form-select form-select-sm" id="cannedResponseSelect" onchange="insertCannedResponse(this.value)">
                            ...
                            <div class="mb-3">
                                <textarea name="message" id="replyMessage" rows="5" class="form-control" placeholder="Type your response to the customer here..." required></textarea>
                            </div>
