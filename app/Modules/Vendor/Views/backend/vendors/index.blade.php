    ...
    <div class="container-fluid py-4">
        ...
        <div class="row align-items-center mb-4">
            <div class="col">
                ...
                <p class="text-muted small mb-0">Oversee registered seller stores, commission commissions, and payout requests.</p>
            </div>
            <div class="col-auto">
                <a href="{{ route('admin.vendors.payouts') }}" class="btn btn-outline-success">
        ...
        <div class="card border-0 shadow-sm mb-4">
            <div class="card-body p-3">
                <form method="GET" action="{{ route('admin.vendors.index') }}" class="row g-2 align-items-center">
                    <div class="col-md-6">
                        <input type="text" name="search" class="form-control" placeholder="Search store name, email, owner..." value="{{ request('search') }}">
                    </div>
                    <div class="col-md-3">
                                ...
                                <tr>
                                    <td class="ps-4">
                                        <div class="d-flex align-items-center gap-2">
                                            @if($store->logo_url)
                                                <img src="{{ $store->logo_url }}" class="border" style="width: 38px; height: 38px; object-fit: cover;">
                                            @else
                                                <div class="avatar-sm bg-primary-subtle text-primary d-flex align-items-center justify-content-center fw-bold" style="width: 38px; height: 38px;">
                                    ...
                                    <td class="pe-4 text-end">
                                        <button class="btn btn-sm btn-outline-primary" data-bs-toggle="modal" data-bs-target="#editModal{{ $store->id }}">
                                            ...
                                            <form method="POST" action="{{ route('admin.vendors.update', $store) }}">
                                                ...
                                                <div class="modal-body">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="number" step="0.01" name="commission_rate" class="form-control" value="{{ $store->commission_rate }}" required>
                                                    </div>
                                                    <div class="mb-3">
