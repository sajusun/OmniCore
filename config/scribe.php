...
return [
    ...
    'title' => (config('app.name', 'OmniCore')) . ' API Reference',

    // A short description of your API. Will be included in the docs webpage, Postman collection and OpenAPI spec.
    'description' => 'Comprehensive, production-ready RESTful API for ' . config('app.name', 'OmniCore') . ' Mobile Apps (Flutter, React Native, iOS, Android) and Web Clients.',
    ...
    'auth' => [
        ...
        'extra_info' => 'Retrieve your access token by calling the <code>POST /api/login</code> or <code>POST /api/register</code> endpoint.',
    ],
